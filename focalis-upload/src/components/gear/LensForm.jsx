...
export function LensForm({ initialLens = null, onSave, onCancel }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
      ...
      <div className="flex gap-3">
        <Field label={isVariableAperture ? 'Ouverture max (grand-angle)' : 'Ouverture maximale (f/)'}>
          <NumberInput
            step="0.1"
        ...
        {isVariableAperture && (
          <Field label="Ouverture max (télé)">
            <NumberInput
              step="0.1"

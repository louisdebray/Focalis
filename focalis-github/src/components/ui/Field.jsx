...
export function TextInput(props) {
  return (
    <input
      className="w-full min-w-0 rounded-xl border border-neutral-200 bg-white px-3 py-2.5 text-[15px] text-neutral-900 outline-none transition-shadow focus:border-accent-400 focus:ring-2 focus:ring-accent-100"
      {...props}
    />
  );
}

...
export function BottomNav({ active, onChange }) {
  return (
    <nav className="fixed inset-x-0 bottom-0 z-40 pb-[max(env(safe-area-inset-bottom),0px)]">
      <div className="glass-surface mx-auto mb-3 flex max-w-lg items-center gap-1 rounded-3xl border border-neutral-200/60 p-1.5 shadow-[0_10px_30px_-8px_rgba(22,22,26,0.25)]">
        {TABS.map((tab) => {
